...
$MESS['SOA_ORDER_MESS_MAIL'] = "На почтовый ящик была отправлена информация о: составе корзины, выбранном способе (временем и местом) доставки, информацией о точке самовывоза/почтамте (график работы, инструкция по тому, как добраться).";
$MESS['SOA_ORDER_CONTACT'] = "В ближайший час с Вами свяжутся для подтверждения заказа.";
...
$MESS['DELIVERY_BLOCK_NAME_DEFAULT'] = "Выберите способ получения";
$MESS['DELIVERY_ADDRESS_BLOCK_NAME_DEFAULT'] = "Адрес доставки";
$MESS['INCORRECT_DELIVERY_ADDRESS'] = "Неверный адрес";
...
$MESS['FREE_PRICE'] = "Бесплатно.";
$MESS['NEXT_DATE'] = "Ближайшая доставка";
$MESS['CHOOSE_DELIVERY_VARIANT_TITLE'] = "Выберите вариант получения.";
$MESS['CHOOSE_ANOTHER_DATE'] = "Выберите другую дату.";
$MESS['SAVED_ADDRESSES'] = "Сохранённые адреса";
$MESS['SAVE_ADDRESS'] = "Сохранить адрес";
$MESS['MORE_ADDRESSES'] = "Другие адреса";